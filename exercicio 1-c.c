...
// Função para copiar a lista L1 para L2, eliminando repetidos
Lista *copiaListaSemRepetidos(Lista *L1)
{
    Lista *L2 = criaLista();
    Lista *atual = L1;
    ...
    while (atual != NULL)
    {
        // Insere apenas se o valor ainda não estiver em L2
...
int main()
{
    ...
    // Copiando a lista L1 para L2 eliminando repetidos
    L2 = copiaListaSemRepetidos(L1);

    printf("Lista L2 (sem repetidos):\n");
    imprimir(L2);
